...
dependency 'merb-auth-slice-password', "0.9.9"
...
dependency "dm-sweatshop", "0.9.7"    # Generate pseudorandom models for testing or populating your development database
